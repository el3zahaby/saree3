			...
			<div class="sidebar right">
				...
				<div class="sidebar-item void buttons">
					<a href="#" class="button big dark purchase">
						<span class="currency">{{$product->products_price}}</span>
						<span>شراء الان!</span>
					</a>
					<a id="addcard" data-product = "{{$product->products_id}}" href="" class="button big tertiary wcart">
						<span class="icon-present"></span>
						أضف للسلة
                    </a>

                    @if (isset(user()->id))
					<a href="#" id="addtofav" data-userid = "{{user()->id}}" data-product_id = "{{$product->products_id}}" class="button big secondary wfav">
				...
				<div class="sidebar-item author-bio">
					...
					<a href="user-profile.html" class="user-avatar-wrap medium">
                        ...
                        <img src="{{url('images/avatars/'.$product->userimage)}}" alt="">
						</figure>
					</a>
					<!-- /USER AVATAR -->
					<p class="text-header"> {!! $product->user_name !!}</p>
					<p class="text-oneline">{!! $product->user_desc !!}</p>
					<!-- SHARE LINKS -->
				...
				<div class="sidebar-item product-info">
					...
					<div class="information-layout">
						...
						<div class="information-layout-item">
							...
							<p>{!! userAt($product->date_created) !!}</p>
						</div>
						<!-- /INFORMATION LAYOUT ITEM -->
						...
						<div class="information-layout-item">
                            ...
                            <p>{!! get_type_trans($product->trans) !!} </p>
				...
				<article class="post">
					...
					<div class="post-image">
						<figure class="product-preview-image large liquid">
                            <img src="{{url('uploads/products/'.get_imgs($product)[0]->img)}}" alt="">
						</figure>
						<!-- SLIDE CONTROLS -->
					...
					<div class="post-image-slides">
						...
						<div class="image-slides-wrap full">
							...
							<div class="image-slides" data-slide-visible-full="8"
                                                      ...
                                                      data-slide-count="9">
                            @foreach(get_imgs($product) as $item => $value)
								<!-- IMAGE SLIDE -->
								<div class="image-slide">
									<div class="overlay"></div>
									<figure class="product-preview-image thumbnail liquid">
                                        <img src="{{asset('uploads/products/'.$value->img)}}" alt="">
									</figure>
								</div>
                                <!-- /IMAGE SLIDE -->
                            @endforeach
...
<script>
        ...
        $("#addcard").on('click' , () => {
			let product_id = $('#addcard').data('product');
            //console.log();
            $.ajax({
                url : "card/add",
                methode :'POST',
                ...
                success:function (data) {
                    console.log(data);
                    alert('add to card don :)');

                    $('.account-cart-quickview').html(data);
                }
            });
        ...
        $("#addtofav").on('click' , () => {
			let product_id = $("#addtofav").data("product_id") ;
			let user_id = $("#addtofav").data("userid");
